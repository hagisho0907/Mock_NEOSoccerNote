...
export function StatsPage() {
  ...
  return (
    <VStack spacing={6} align="stretch">
      ...
      {/* セッション登録モーダル */}
      <Modal isOpen={isSessionModalOpen} onClose={onSessionModalClose} size="6xl">
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>セッション登録</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
          ...
          <ModalFooter>
            ...
            <Button colorScheme="brand" onClick={onSessionModalClose}>
              登録完了
            </Button>
          </ModalFooter>
        </ModalContent>
